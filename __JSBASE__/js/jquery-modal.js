jQuery.fn.modal = function(options){
	...
	function openModal(){
		/*CREATE ELEMENTS*/
		$('body').append($('<img />').attr({src: URLBASE+"figuras/load.gif", width: 88, height: 78, alt: "", className: 'load'})).append($('<div></div>').addClass('bg_modal')).append($('<div></div>').addClass('view_modal'));
