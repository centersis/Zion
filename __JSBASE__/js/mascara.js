...
{	
	...
	this.blur(function()
	{
		...
		{
			valor = formata(valor);	
			valor = convertePartes(valor);
		}
				
		$(this).val(valor);
 	});	
/**
 * mantendo o comentario para possivel rollback futuro, porem essas funçoes existes no UTIL.JS
 */
...
//			if(separa == false)
//			{
//				if((vPosicao == "," && i == aux) || (vPosicao == "." && i == aux))
//				{
//					separa   = true;
//					numeros += ",";
//				}
