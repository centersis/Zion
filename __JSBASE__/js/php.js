   ...
   is the minimum scale for the result. */
     ...
     //  of the result.
        ...
        if (scale_min > diff_scale) {
            ...
            if(n1.n_scale < n2.n_scale){
                var i;
                for (i=n1.n_scale;i<n2.n_scale;i++) {
                    n1.n_value[n1.n_len+i] = 0;
                }
            }
            if(n1.n_scale < n2.n_scale){
                aux1 = n1;
                aux2 = n2;
                for(j = n1.n_scale; j <=n2.n_scale; j++){
                    aux1 = bcmul(aux1, 10, n2.n_scale);
                    aux2 = bcmul(aux2, 10, n2.n_scale);
                }
                
                resultfinal = aux1- aux2;

                for(j = n1.n_scale; j <=n2.n_scale; j++){
                    aux1 = bcdiv(aux1, 10, n1.n_scale);
                    aux2 = bcdiv(aux2, 10, n2.n_scale);
                    resultfinal = bcdiv(resultfinal, 10, n2.n_scale);
                }
                n1 = aux1;
                n2 = aux2;
                return resultfinal;
