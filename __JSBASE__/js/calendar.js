...
$(document).ready(function() {
   ...
   popUpCal.regional['pt_BR'] = {clearText: 'Limpar', closeText: 'Fechar',prevText: '&lt;Ant', nextText: 'Prox&gt;', currentText: 'Hoje',dayNames: ['D','S','T','Q','Q','S','S'],monthNames: ['Janeiro','Fevereiro','Mar&ccedil;o','Abril','Maio','Junho','Julho','Agosto','Setembro','Outubro','Novembro','Dezembro']};
   //popUpCal.setDefaults({autoPopUp: 'button', buttonImageOnly: true, buttonText:'Selecione a Data', buttonImage: URLBASE+'figuras/cal.gif'});
