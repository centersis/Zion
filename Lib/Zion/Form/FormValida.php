        ...
        foreach (($attrs) as $value) {
            ...
            switch ($value) {
                ...
                case 'acao':
                    ...
                    } elseif (strtoupper($input->getAcao()) == 'SENHA' and $input->getNome() == 'validaSenhaUser') {
