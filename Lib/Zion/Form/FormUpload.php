...
class FormUpload extends FormBasico
{
    ...
    public function setMultiple($multiple)
    {
        if (\is_bool($multiple)) {
            ...
            throw new ErrorException("multiple: Valor não booleano.");
        }
    }
    ...
    public function setTratarComo($tratarComo)
    {
        if (!empty($tratarComo)) {
            ...
            throw new ErrorException("tratarComo: Valor desconhecido. Para utilizar recursos de imagem, informe 'IMAGEM' para este atributo.");
        }
    }
