...
//Valindando
if(empty($Caminho)) exit("Caminho Inválido!");

if(!is_numeric($ArquivoCod)) exit("Código Inválido!");

if(empty($Tabela)) exit("Tabela Inválida!");

if($Modo != 'Download' and $Modo != 'Ver') exit("Modo Inválido!");
...
if (!file_exists($Arquivo)) die("Arquivo não Existe!");
