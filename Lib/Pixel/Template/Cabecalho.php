...
class Cabecalho extends \Zion\Layout\Padrao
{
    ...
    public function getCabecalho($conteudoHeader = '')
    {
        ...
        $buffer .= $this->html->abreTagAberta('link', array('href' => SIS_URL_BASE_STATIC . 'libs/font-awesome/4.3.0/css/font-awesome.min.css', 'rel' => 'stylesheet', 'type' => 'text/css'));
        ...
        $buffer .= $this->html->abreTagAberta('script', array('src' => SIS_URL_BASE_STATIC . 'libs/jquery/2.0.3/jquery.min.js')) . $this->html->fechaTag('script');
        $buffer .= $this->html->abreTagAberta('script', array('src' => SIS_URL_BASE_STATIC . 'PixelAdmin/1.3.0/assets/javascripts/socket.io-1.2.0.min.js')) . $this->html->fechaTag('script');
        $buffer .= $this->html->abreTagAberta('script', array('src' => SIS_URL_BASE_STATIC . 'PixelAdmin/1.3.0/assets/javascripts/websocket.js')) . $this->html->fechaTag('script');
